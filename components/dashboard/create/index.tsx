...
export const Create: React.FC<Props> = ({
    ...
    const formType = useRef<HTMLSelectElement>();
    ...
    const handlePopupFormSubmit = async (e) => {
        ...
        localStorage.setItem("form_type", formType.current?.value);
        ...
        let data = {
            ...
            fvid: fvid,
            userId: uid,
            formType: formType.current?.value
        };
                    ...
                    <div className={styles.container}>
                        ...
                        <form onSubmit={handlePopupFormSubmit}>
                            <div className={styles.container__form}>
                                ...
                                <input
                                    className="p-4 mt-2 border-2 border-gray-200 rounded-md w-full outline-none focus:border-indigo-600"
                                    id="quiz_title"
                                    type="text"
                                ...
                                <select ref={formType} name="form_type" id="form_type" className="p-4 mt-2 border-2 border-gray-200 rounded-md w-full outline-none focus:border-indigo-600">
                                    <option value="default_form">Empty Form</option>
                                    <option value="quiz">Quiz</option>
                                    <option value="admissions_form">Admissions Form</option>
